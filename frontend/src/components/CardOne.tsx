  ...
  return (
    <React.Fragment>
      <NavLink to="/forms/CompList">
        ...
        >
          {/* Tooltip for View Companies - Positioned at Top Right */}
          {showCardTooltip && (
          ...
          <div className="mt-4 flex items-end justify-between">
            ...
            <div className="flex space-x-2 relative">
              <NavLink to="/forms/AddCompnay">
                <button className="flex h-10 w-10 text-lg items-center justify-center rounded-full border border-[#b5d8fc] bg-primary text-white transition duration-300 hover:scale-125 relative group">
                  <FaPlus />
                  {/* Tooltip for Add Company */}
